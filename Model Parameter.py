...
# Create our addin definition object
    ...
    my_addin.add_command(
        ...
        SamplePaletteShowCommand,
        {
            ...
            'palette_html_file_url': 'palette_html/Model Parameter.html',
    ...
    # my_addin.add_custom_event("Model Parameter_message_system", SampleCustomEvent1)

    # my_addin.add_document_event("Model Parameter_open_event", app.documentActivated, SampleDocumentEvent1)
    # my_addin.add_document_event("Model Parameter_close_event", app.documentClosed, SampleDocumentEvent2)

    # my_addin.add_workspace_event("Model Parameter_workspace_event", ui.workspaceActivated, SampleWorkspaceEvent1)

    # my_addin.add_web_request_event("Model Parameter_web_request_event", app.openedFromURL, SampleWebRequestOpened)

    # my_addin.add_command_event("Model Parameter_command_event", app.userInterface.commandStarting, SampleCommandEvent)
